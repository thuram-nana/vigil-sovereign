...
- **Witnessed:** the *protocol* ships (`transparency.py`, `remediation/attestation_witness.py`) AND — **NEW,
  A3 (#TBD)** — the LIVE co-sign **TRANSPORT** that was deferred (`apps/sigil/spine/witness.py:37-39`) now
