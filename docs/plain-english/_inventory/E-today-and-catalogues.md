...
| **3 / 2 / 17 / 1 / 24** | Detector kinds with external / own-infrastructure / local-socket / retained-source / fixture-only evidence (the generated breakdown below is the source of truth) |
