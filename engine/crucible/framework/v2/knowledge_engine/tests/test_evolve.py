...
_LEADS = [
    ...
    {"id": "CVE-2024-0002", "bug_class": "subdomain_takeover"},            # NOT oracle-known → coverage gap
                                                                           # (csrf USED to be uncovered; W16-STD-5
                                                                           #  gave it an oracle; prototype_pollution
                                                                           #  was next but Wave 2.2 covered it, so
                                                                           #  pick a still-uncovered class here)
...
def test_plan_has_horizon_and_only_uncovered_coverage_gaps(tmp_path):
    ...
    assert [g.bug_class for g in plan.coverage_gaps] == ["subdomain_takeover"]   # ONLY the oracle-uncovered class
