...
def services_data() -> dict[str, Any]:
    """System readiness + docker-service state for the System screen (READ-ONLY): binaries, both venvs,
    writable dirs, the four UI ports, and every docker service's state (gateway + qdrant/neo4j/otel).
