    ...
    /* ====================================================================== */
    {
      ...
      blocks: [
        ...
        { note: "To check what is actually in force, open Governance & Gate Audit (#/governance): the tier "
          ...
          + "a shell. A refused backend is refused BEFORE the SDK is imported or a client is constructed, so "
